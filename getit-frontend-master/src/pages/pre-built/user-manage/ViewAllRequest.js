...
import { statusChange, statusReject } from "../../../reducers/ticketRequest.reducer";
        ...
        <div className="nk-tnx-details mt-sm-3">
          <Row className="gy-3">
            ...
            {selectedData?.reportingManager && (
              <Col lg={4}>
                <span className="sub-text">Reporting manager</span>
          ...
          <Col lg={12} className="d-flex justify-content-between ">
            <Col lg={6} className="">
              {typeOfTable == "1" && selectedData?.status === "Pending" && (
                <Button color="warning" className="mt-2 btn-sm rounded-pill" onClick={() => handleStatus()}>
                  Cancel
                </Button>
              )}
            </Col>
            <Col lg={6} className="d-flex justify-content-between">
              {typeOfTable == "2" && (selectedData?.status == "L1 Approved" || selectedData?.status === "Pending") && (
